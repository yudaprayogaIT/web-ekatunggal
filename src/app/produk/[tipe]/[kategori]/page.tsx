...
// //   useEffect(() => {
// //     // Hook selalu dipanggil—logika validitas hanya di dalamnya
...
// //   // Jika tipe tidak valid, tampilkan 404/Invalid Tipe
// //   if (!isValidTipe) {
// //     return (
...
//   const [produk, setProduk] = useState<Produk[]>([]);
//   // state untuk mengontrol apakah menampilkan semua produk atau hanya 5
...
//   // Hitung daftar produk yang akan ditampilkan (5 pertama atau semua)
...
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-8">
//           {displayedProduk.map((item: Produk, index: number) => {
//             return <ProductCard data={item} key={index} />;
//           })}
//         </div>

//         {/* Jika total produk lebih dari 5, tampilkan tombol See More / See Less */}
//         {produk.length > 4 && (
