...
export const AboutComponent = () => {
  ...
  return (
    <section className="my-10 w-full overflow-hidden">
      <div className="relative container max-w-full mx-auto flex flex-col lg:flex-row items-start gap-8 px-4 md:px-12">
        {/* Kiri: Teks */}
        <div className="relative flex-1 -mt-14 lg:mt-4 2xl:mt-0 space-y-4 lg:space-y-8">
          <div className="absolute right-0 lg:left-0 top-10 sm:top-13 lg:top-12d 2xl:top-14 h-[32%] w-1 bg-[var(--colorYellow)]" />
          ...
          <motion.div
            ...
            className="px-2 mt-10 lg:pl-4 lg:w-[90%]"
          >
            <h2 className="uppercase text-[var(--colorRed)] font-[montserrat] text-lg md:text-2xl 2xl:text-3xl font-bold lg:mb-2">
              Ekatunggal
            </h2>
          ...
          <motion.div
            ...
            initial={{ opacity: 0, x: 60 }}
            transition={{ duration: 0.6 }}
            className="relative px-2 lg:pr-6 text-right lg:w-[90%]"
          >
            <h2 className="uppercase text-[var(--colorBlack)] font-[montserrat] text-lg md:text-2xl font-bold lg:mb-2">
            ...
            <div className="absolute bottom-4 h-[80%] sm:h-[100%] sm:-bottom-2 lg:h-[80%] lg:bottom-4 w-1 bg-[var(--colorYellow)] left-0 lg:left-auto lg:right-0" />
          </motion.div>
        </div>

        {/* Kanan: Gambar */}
        <motion.div
          className="relative flex-1 w-full -mt-10 lg:mt-0 2xl:mt-10 order-first lg:order-last"
