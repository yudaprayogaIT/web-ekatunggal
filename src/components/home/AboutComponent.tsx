      ...
      <div className="relative container max-w-full mx-auto flex flex-col md:flex-row items-start gap-8 px-4 md:px-12">
        ...
        <div className="relative flex-1 -mt-14 md:mt-4 space-y-4 md:space-y-8">
          ...
          <motion.div
            ...
            className="px-2 mt-10 md:pl-4 md:w-[90%]"
          >
            <h2 className="uppercase text-[var(--colorRed)] font-[montserrat] text-lg md:text-2xl 2xl:text-3xl font-bold md:mb-2">
              Ekatunggal
            </h2>
          ...
          >
            <h2 className="uppercase text-[var(--colorBlack)] font-[montserrat] text-lg md:text-2xl font-bold md:mb-2">
