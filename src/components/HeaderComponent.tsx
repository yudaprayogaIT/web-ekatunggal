            ...
            <div className="navbar bg-base-100 shadow-sm">
                <div className="navbar-start">
                    <Image
                        ...
                        width={80}
                        height={60}
                        className="w-auto px-4 h-[41px]"
                    />
                </div>
                <div className="navbar-end uppercase font-bold "
                    ...
                    <div className="dropdown">
                        ...
                        <ul
                            tabIndex={0}
                            className=" menu menu-sm dropdown-content bg-white rounded-md z-50 mt-2 p-4 shadow-lg right-0 mx-1" style={{ width: "95vw" }}
                        >
                            <li>
                    ...
                    <div className="hidden lg:flex">
                        <ul className="menu menu-horizontal px-1 pr-6 space-x-10 text-[0.9em]">
                            <li>
                                <Link href="#">tentang kami</Link>
                            </li>
                            <li>
