  ...
  return (
    <section className="leading-0">
      <div className="carousel w-full h-[82vh]">
        ...
        <div
          id="item1"
          className="carousel-item w-full relative overflow-hidden"
        >
          <Image
            src="/img/hero.png"
            alt="gedung_etm"
          ...
          />
          <div className="content w-[50%] text-[var(--colorWhite)] font-[montserrat] font-bold absolute top-[45%] left-[6%] z-10">
            <h2 className="text-[1.8vw] leading-11">
              APAPUN KEBUTUHANMU, SOLUSINYA, #EKATUNGGAL
            </h2>
            <a
              href="https://wa.me/085788837057"
              className="wa mt-[0.5vw] p-[0.6vw] flex justify-center items-center bg-[var(--colorYellow)] w-[8vw] h-[2.4vw] rounded-2xl uppercase text-[0.8vw] text-[var(--colorBlack)] "
            >
              <div className="button-text p-1">
                Tanya <span className="text-[var(--colorRed)]">Vika</span>
              </div>
              <Image
                src="/img/wa.png"
                width={35}
      ...
      <section className="label">
        <div className="label-text font-[montserrat] font-bold">
